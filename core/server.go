...
import (
	"ThroneGtkCore/gen"
	"ThroneGtkCore/internal/boxbox"
	"ThroneGtkCore/internal/boxdns"
	"ThroneGtkCore/internal/boxmain"
	"ThroneGtkCore/internal/process"
	"ThroneGtkCore/internal/sys"
	"ThroneGtkCore/internal/wg"
	"ThroneGtkCore/internal/xray"
	"ThroneGtkCore/test_utils"
	"context"
	"errors"
	"fmt"
	"log"
...
func (s *server) IsPrivileged(ctx context.Context, _ *gen.EmptyReq) (*gen.IsPrivilegedResponse, error) {
	...
	return &gen.IsPrivilegedResponse{HasPrivilege: To(hasTunPrivilege())}, nil
}
